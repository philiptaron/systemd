...
One use case for dropping in JSON user record files like this involves invoking VMs or containers which shall be able to access a user home directory mounted in from the host, through a propagated user record.
