...
This is particularly useful when thinking about network booting: a boot menu entry defined that way could use the `uki-url` stanza to reference a `UKI` on some network server.
