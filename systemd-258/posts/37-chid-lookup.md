...
CHIDs are a Microsoft spec that calculates various UUIDs identifying the model of the local system.
...
But how do you actually figure out the CHIDs for your local system?
The new v258 `systemd-analyze` command `chid` will help you there: it will calculate all standard CHIDs of the local system, plus some extended CHIDs specific to systemd.
...
via `EFI_EDID_DISCOVERED_PROTOCOL`

---

[systemd-analyze]: https://www.freedesktop.org/software/systemd/man/258/systemd-analyze.html
[sd-stub]: https://www.freedesktop.org/software/systemd/man/258/systemd.exec.html
