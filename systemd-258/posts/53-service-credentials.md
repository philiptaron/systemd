...
Yeah, the secrets are then bound to your uid, your user name, your system and your OS, and can only be unlocked if all that checks out. This should protect you nicely from offline attacks, and yes you can store the secrets in a untrusted place without risking their security.

---

[systemd-cred]: https://www.freedesktop.org/software/systemd/man/258/systemd-cred.html
