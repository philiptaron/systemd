...
(But fear not, `D-Bus` support is going to stay, we are pluralistic in that sense, we just believe `Varlink` is a lot more attractive for a good chunk of use cases, in particular in the server/web world, where JSON is much more common.)
