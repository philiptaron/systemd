...
55️⃣ Here's the 55th post highlighting key new features of the upcoming v258 release of systemd. [#systemd258](https://mastodon.social/tags/systemd258)
...
> **[@kmichal](https://fosstodon.org/@kmichal)** "delegating certain BPF functionality to subcgroups" the delegation scope for tokens are user namespaces and when you're in such, then you can decorate visible cgroups with allowed BPF progs.
