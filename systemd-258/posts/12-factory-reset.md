...
The idea is not erase all EFI vars... just the OS-owned subset. The way I envision this is to work is to primarily rely on the namespace of EFI vars (you know, that UUID that indicates ownership of the EFI var) to filter which ones to keep and which ones to erase.
