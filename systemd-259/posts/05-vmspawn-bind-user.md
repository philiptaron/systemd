...
With v259 the same option is now available for systemd-vmspawn too. Or in other words, one simple switch will propagate the user record into the VM (via system credentials), and make the home dir available too (via virtiofs).
